 ...
 * // http://localhost:3000/sitemaps/to/country/zh/sitemap.xml
 *
 * @example
 * // In a production environment, the English sitemap is available at:
 * // http://localhost:3000/sitemaps/to/country/zh/sitemap.xml
 * // https://travolic.com/sitemaps/to/country/zh/sitemap.xml
 */
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  return countries.map((country) => {
    ...
    return {
      url: `https://travolic.com/zh/cheapest-flights/to/country/${country.code.toLowerCase()}/${formatString(country.name)}`,
