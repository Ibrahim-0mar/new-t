 ...
 * // http://localhost:3000/sitemaps/from/country/hi/sitemap.xml
 *
 * @example
 * // In a production environment, the English sitemap is available at:
 * // http://localhost:3000/sitemaps/from/country/hi/sitemap.xml
 * // https://travolic.com/sitemaps/from/country/hi/sitemap.xml
 */
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return countries.map((country) => {
    ...
    return {
      url: `${fullUrl}/hi/cheapest-flights/from/country/${country.code.toLowerCase()}/${formatString(country.name)}`,
